...
## Deployment
#### Docker Standalone
The following is how to deploy the Conjur PKI Service within a docker compose file. Remember to provide the correct `CONJUR_ACCOUNT`, `CONJUR_APPLIANCE_URL` and `CONJUR_AUTHN_API_KEY`.
  ...
  pkiaas:
    ...
    environment:
      ...
      CONJUR_SSL_CERTIFICATE: |-
        ...
        
        ...
        
        -----END CERTIFICATE-----
        -----BEGIN CERTIFICATE-----
